$(document).ready(function() {
	...
	var subscription = ['5~CCCAGG~BTC~USD', '5~CCCAGG~ETH~USD', '5~CCCAGG~BTS~USD', '5~CCCAGG~AMIS~USD', '0~openledger~BTS~USD', '5~EtherDelta~AMIS~ETH', '11~BTC', '11~ETH', '11~AMIS', '11~BTS'];
